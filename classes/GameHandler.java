...
public class GameHandler {
    public static void main(String [] args) {
        ...
        Card card1 = Card.getCard("Qual a diferen�a entre uma classe e objeto em Java?", "Uma classe � uma cole��o de defini��es de atributos e m�todos que todos os objetos instanciados daquela classe possuem.");
        card1.saveCardToFile();
        card1 = Card.loadCardFromFile("./data/content/card_1.ser");
//        card1.printCard();
        Card card2 = Card.getCard("Como o avi�o avoa se ele n�o bate as asa?", "Vroom");
...
//        card2.printCard();
        ...
        Card question2 = Card.getCard("Qual o melhor sabor de Corote?", "Misc", "P�ssego");
